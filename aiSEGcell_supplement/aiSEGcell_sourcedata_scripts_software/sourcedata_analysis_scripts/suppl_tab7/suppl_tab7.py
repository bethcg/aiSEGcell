...
path_out = '../output/suppl_tab7/'
os.makedirs(path_out, exist_ok=True)

# load data
df = pd.read_csv(f'./raw_data/suppl_tab7.csv')
...
# save to csv
mu.to_csv(os.path.join(path_out, 'suppl_tab7_mean.csv'), index=False)
sd.to_csv(os.path.join(path_out, 'suppl_tab7_std.csv'), index=False)
