...
path_out = '../output/suppl_tab13/'
os.makedirs(path_out, exist_ok=True)

# load data
df = pd.read_csv(f'./raw_data/suppl_tab13.csv')
...
# save to csv
mu.to_csv(os.path.join(path_out, 'suppl_tab13_mean.csv'), index=False)
sd.to_csv(os.path.join(path_out, 'suppl_tab13_std.csv'), index=False)
