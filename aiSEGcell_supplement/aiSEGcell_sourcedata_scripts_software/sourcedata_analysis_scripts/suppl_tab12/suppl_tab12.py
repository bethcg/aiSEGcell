...
path_out = '../output/suppl_tab12/'
os.makedirs(path_out, exist_ok=True)

# load data
df = pd.read_csv(f'./raw_data/suppl_tab12.csv')
...
# save to csv
mu.to_csv(os.path.join(path_out, 'suppl_tab12_mean.csv'), index=False)
sd.to_csv(os.path.join(path_out, 'suppl_tab12_std.csv'), index=False)
