...
path_out = '../output/suppl_tab8/'
os.makedirs(path_out, exist_ok=True)

# load data
df = pd.read_csv(f'./raw_data/suppl_tab8.csv')
...
# save to csv
mu.to_csv(os.path.join(path_out, 'suppl_tab8_mean.csv'), index=False)
sd.to_csv(os.path.join(path_out, 'suppl_tab8_std.csv'), index=False)
